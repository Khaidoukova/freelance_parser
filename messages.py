...
tg_channels = [1179016388, 1400981710]
tg_keywords = ['python', 'дизайн', 'менеджер']


def main(channels, keywords, chat_id):
    """
    ...
    messages_list = []  # список для сообщений
...
# main(tg_channels, tg_keywords, 876689099)
